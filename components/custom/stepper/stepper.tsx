...
const RowSteps = React.forwardRef<HTMLButtonElement, RowStepsProps>(
  (
    ...
    const colors = React.useMemo(() => {
      ...
      switch (color) {
        case "primary":
          userColor = "[--step-color:#F2D443]";
          fgColor = "[--step-fg-color:oklch(0.985 0 0)]";
          break;
        case "secondary":
          userColor = "#3F3F46";
          fgColor = "[--step-fg-color:oklch(0.985 0 0)]";
            ...
            return (
              ...
              >
                <button
                  ...
                  className={cn(
                    "group rounded-large flex flex-row w-full cursor-pointer items-center justify-center gap-x-3 py-2.5",
                    stepClassName
                  )}
